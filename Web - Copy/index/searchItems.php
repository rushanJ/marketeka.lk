...
<form class=\"form-inline\" method= \"GET\" action=\"../searchResult\">
  ...
  <div class=\"input-group\">
				<span class=\"input-group-addon\" id=\"sizing-addon2\">Item Name</span>
				<input required name=\"itemName\"  type=\"text\" class=\"form-control\" placeholder=\"Enter Item Name\" aria-describedby=\"sizing-addon2\">
			</div>
  </div>
  <div class=\"input-group\">
				<span class=\"input-group-addon\" id=\"sizing-addon2\">District</span>
  ...
  <div class=\"input-group\">
				<span class=\"input-group-addon\" id=\"sizing-addon2\"> Nearest Town</span>
				<input name=\"nearestTown\" type=\"text\" required class=\"form-control\" placeholder=\" Enter Nearest Town\" aria-describedby=\"sizing-addon2\">
            </div>
            <button type=\"submit\" class=\"btn btn-primary btn-lg\">Find</button>
            </div>
</form>
